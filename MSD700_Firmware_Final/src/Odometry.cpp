 ...
 * File        : Odometry.cpp
 * Description :
 *   Differential-drive odometry implementation for MSD700.
 *
 * Features:
 *   - Quadrature encoder decoding via pin-change interrupts
...
void Odometry::begin() {
    _metersPerTick = 1.0f /ODO_TICKS_PER_METER;
...
/******************************************************************************
 * Publish odometry telemetry in JSON format.
 ******************************************************************************/
void Odometry::sendJson(Stream &serial) {
    ...
    // Transmit only on motion updates and send one final stationary frame
    // when movement stops
...
/******************************************************************************
 * Generate encoder calibration statistics based on a known travel distance.
 ******************************************************************************/
...
/******************************************************************************
 * Reset encoder counts, pose estimate, and velocity state.
 ******************************************************************************/
void Odometry::reset() {
    noInterrupts();
    _leftTicks  = 0;
